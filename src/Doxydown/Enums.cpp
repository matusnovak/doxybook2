...
namespace Doxydown {
    template <>
    extern Doxydown::Kind toEnum<Doxydown::Kind>(const std::string& str) {
    ...
    template <>
    extern std::string toStr<Doxydown::Kind>(const Kind value) {
        switch (value) {
            case Kind::DEFINE:
                return "define";
            case Kind::CLASS:
    ...
    template <>
    extern Doxydown::Virtual toEnum<Doxydown::Virtual>(const std::string& str) {
    ...
    template <>
    extern std::string toStr<Doxydown::Virtual>(const Virtual value) {
        switch (value) {
    ...
    template <>
    extern Doxydown::Visibility toEnum<Doxydown::Visibility>(const std::string& str) {
    ...
    template <>
    extern std::string toStr<Doxydown::Visibility>(const Visibility value) {
        switch (value) {
    ...
    template <>
    extern Doxydown::Type toEnum<Doxydown::Type>(const std::string& str) {
    ...
    template <>
    extern std::string toStr<Doxydown::Type>(const Type value) {
        switch (value) {
            case Type::DEFINES:
                return "defines";
